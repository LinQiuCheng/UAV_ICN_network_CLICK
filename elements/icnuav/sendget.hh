#ifndef CLICK_SENDGET_HH
#define CLICK_SENDGET_HH
...
SendGet([INTERVAL, DATA, I<KEYWORDS>])
...
class SendGet : public Element { public:

  SendGet() CLICK_COLD;

  const char *class_name() const		{ return "SendGet"; }
